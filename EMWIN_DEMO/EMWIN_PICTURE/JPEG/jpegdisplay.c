...
void jpegdisplay_demo(void)
{
	...
	//{
		...
		//displyjpeg("0:/PICTURE/JPEG/test.jpg",0,0,0,1,1);
		displyjpeg("0:/PICTURE/logo.jpg",0,0,0,1,1);
		GUI_Delay(2000);
		//GUI_Clear();
	/*
        ...
        GUI_DispStringHCenterAt("在LCD中间显示一张缩小1/4的加载到RAM中的JPEG图片",240,0);
		displyjpeg("0:/PICTURE/JPEG/实例图片.jpg",1,0,0,1,4);
		GUI_Delay(1000);
		GUI_Clear();
        
		GUI_DispStringHCenterAt("在指定位置显示一张无需加载的JPEG图片",240,0);
		displayjpegex("0:/PICTURE/JPEG/SIM900A2.jpg",0,0,0,1,1);
		GUI_Delay(1000);
		GUI_Clear();
        ...
        GUI_DispStringHCenterAt("在LCD中间显示一张缩小1/4的无需加载的JPEG图片",240,0);
        displayjpegex("0:/PICTURE/JPEG/实例图片.jpg",1,0,0,1,4);
		GUI_Delay(1000);
		GUI_Clear();
		 */
	//}
