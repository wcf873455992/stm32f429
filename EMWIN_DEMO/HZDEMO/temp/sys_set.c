...
板载:10M/100M以太网PHY芯片\r\n\
	...
	*/
//对话框资源列表
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_sys_set[] = {
		...
		case WM_NOTIFY_PARENT:
			...
			switch(Id) 
			{
				...
				case ID_BUTTON_2: 
					...
					{
						case WM_NOTIFICATION_RELEASED:
							GUI_EndDialog(hDialog_sys_set, 0 );
							break;
					}
					break;
...
{
	GUI_CURSOR_Show();
	hDialog_sys_set = GUI_CreateDialogBox(_aDialogCreate_sys_set, GUI_COUNTOF(_aDialogCreate_sys_set), _cbDialog, hDialog, 0, 0);	
	//GUI_Exec();
}
