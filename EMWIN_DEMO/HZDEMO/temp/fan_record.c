...
板载:10M/100M以太网PHY芯片\r\n\
	...
	*/
//对话框资源列表
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_fan_record[] = {
  { FRAMEWIN_CreateIndirect, 	"风机记录", 	ID_FRAMEWIN_0, 	0, 		0, 		800, 	480, 	FRAMEWIN_CF_MOVEABLE, 0x64, 0 },
		...
		case WM_NOTIFY_PARENT:
			...
			switch(Id) 
			{
				...
				case ID_BUTTON_2: 
					...
					{
						case WM_NOTIFICATION_RELEASED:
							GUI_EndDialog(hDialog_fan_record, 0 );
							break;
					}
					break;
...
void Fan_Record(void) 
{
	GUI_CURSOR_Show();
	hDialog_fan_record = GUI_CreateDialogBox(_aDialogCreate_fan_record, GUI_COUNTOF(_aDialogCreate_fan_record), _cbDialog, hDialog, 0, 0);	
	//GUI_Exec();
}