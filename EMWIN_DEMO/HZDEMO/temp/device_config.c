...
板载:10M/100M以太网PHY芯片\r\n\
	...
	*/
//对话框资源列表
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_device_congfig[] = {
  { FRAMEWIN_CreateIndirect, 	"设备配置", 	ID_FRAMEWIN_0, 	0, 		0, 		800, 	480, 	FRAMEWIN_CF_MOVEABLE, 0x64, 0 },
		...
		case WM_NOTIFY_PARENT:
			...
			switch(Id) 
			{
				...
				case ID_BUTTON_2: 
					...
					{
						case WM_NOTIFICATION_RELEASED:
							GUI_EndDialog(hDialog_config, 0 );
							break;
					}
					break;
...
{
	GUI_CURSOR_Show();
	hDialog_config = GUI_CreateDialogBox(_aDialogCreate_device_congfig, GUI_COUNTOF(_aDialogCreate_device_congfig), _cbDialog, hDialog, 0, 0);	
	//GUI_Exec();
}
