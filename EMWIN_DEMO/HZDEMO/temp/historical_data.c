...
WM_HWIN hDialog_historical_data;
...
板载:10M/100M以太网PHY芯片\r\n\
	...
	*/
//对话框资源列表
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_historical_data[] = {
  { FRAMEWIN_CreateIndirect, 	"系统设置", 	ID_FRAMEWIN_0, 	0, 		0, 		800, 	480, 	FRAMEWIN_CF_MOVEABLE, 0x64, 0 },
		...
		case WM_NOTIFY_PARENT:
			...
			switch(Id) 
			{
				...
				case ID_BUTTON_2: 
					...
					{
						case WM_NOTIFICATION_RELEASED:
							GUI_EndDialog(hDialog_historical_data, 0 );
							break;
					}
					break;
...
void Historical_Data(void) 
{
	GUI_CURSOR_Show();
	hDialog_historical_data = GUI_CreateDialogBox(_aDialogCreate_historical_data, GUI_COUNTOF(_aDialogCreate_historical_data), _cbDialog, hDialog, 0, 0);	
	//GUI_Exec();
}
